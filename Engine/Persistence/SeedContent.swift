...
public enum SeedContent {
    ...
    public static func crownForces() -> [EnemyType] {
        [
            EnemyType(
                id: "loyalist_militia", name: "Loyalist Militia",
            ...
            EnemyType(
                id: "drummer", name: "Regimental Drummer",
            ...
            EnemyType(
                id: "redcoat_regular", name: "Redcoat Regular",
            ...
            EnemyType(
                id: "light_infantry", name: "Light Infantry",
            ...
            EnemyType(
                id: "hessian_jager", name: "Hessian Jäger",
            ...
            EnemyType(
                id: "hessian_fusilier", name: "Hessian Fusilier",
            ...
            EnemyType(
                id: "native_warrior", name: "Native Warrior",
            ...
            EnemyType(
                id: "light_dragoon", name: "Light Dragoon",
            ...
            EnemyType(
                id: "royal_artillery", name: "Royal Artillery",
            ...
            EnemyType(
                id: "mounted_officer", name: "Mounted Officer",
            ...
            EnemyType(
                id: "foot_guards", name: "Foot Guards",
    ...
    public static func starterTowers() -> [TowerType] {
        [
            ...
            TowerType(id: "field_cannon", name: "Field Cannon", levels: [
            ...
            TowerType(id: "volley_line", name: "Volley Line", levels: [
    ...
    public static func concordRoad() -> LevelDefinition {
        LevelDefinition(
            id: "concord_road",
            name: "Concord Road",
            startingGold: 260,
            ...
            waves: [
                Wave(startTime: 5, spawns: [
                    SpawnEntry(enemyTypeID: "loyalist_militia", count: 8, interval: 1.3),
                ]),
                Wave(startTime: 40, spawns: [
                    SpawnEntry(enemyTypeID: "loyalist_militia", count: 6, interval: 1.1),
                    SpawnEntry(enemyTypeID: "redcoat_regular", count: 4, interval: 1.6, delay: 4),
                ]),
                Wave(startTime: 80, spawns: [
                    SpawnEntry(enemyTypeID: "light_infantry", count: 6, interval: 1.0),
                    SpawnEntry(enemyTypeID: "redcoat_regular", count: 6, interval: 1.4, delay: 3),
                    SpawnEntry(enemyTypeID: "drummer", count: 1, interval: 1.0, delay: 6),
                ]),
                Wave(startTime: 125, spawns: [
                    SpawnEntry(enemyTypeID: "hessian_fusilier", count: 5, interval: 1.5),
                    SpawnEntry(enemyTypeID: "hessian_jager", count: 4, interval: 1.2, delay: 2),
                    SpawnEntry(enemyTypeID: "drummer", count: 1, interval: 1.0, delay: 5),
                ]),
                Wave(startTime: 175, spawns: [
                    SpawnEntry(enemyTypeID: "redcoat_regular", count: 8, interval: 1.2),
                    SpawnEntry(enemyTypeID: "drummer", count: 1, interval: 1.0, delay: 3),
                    SpawnEntry(enemyTypeID: "grenadier", count: 2, interval: 4.0, delay: 6),
                    SpawnEntry(enemyTypeID: "mounted_officer", count: 1, interval: 1.0, delay: 8),
                ]),
            ]
        )
    }
